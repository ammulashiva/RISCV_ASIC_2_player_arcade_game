...
spike pk out
```
### spike output on console:

```
ammula-shiva-kumar@ammula-shiva-kumar-HP-Laptop-15-da1xxx:~$ spike riscv64-unknown-elf-gcc -march=rv64i -mabi=lp64 -ffreestanding -o out arcadespike1.c
